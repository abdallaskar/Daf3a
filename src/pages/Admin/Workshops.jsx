          ...
          <div className="bg-surface shadow-lg rounded-lg p-8 transition-theme">
            ...
            <div className="border-default border-b mb-6">
              <nav className="flex gap-8">
                <a className="py-4 px-1 border-b-2 border-link text-link font-semibold" href="#">Calendar</a>
                <a className="py-4 px-1 border-b-2 border-transparent text-secondary hover:text-link hover:border-link" href="#">Analytics</a>
                <a className="py-4 px-1 border-b-2 border-transparent text-secondary hover:text-link hover:border-link" href="#">Content Library</a>
              </nav>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
              <div className="card">
                ...
                <div className="grid grid-cols-7 gap-2 text-center">
                  ...
                  <div className="font-bold text-secondary">S</div>
                  <div
                    className="col-start-4 p-2 rounded-full hover-surface cursor-pointer"
                  >
                    1
                  </div>
                  <div
                    className="p-2 rounded-full hover-surface cursor-pointer"
                  >
                    2
                  </div>
                  <div
                  ...
                  <div
                    className="p-2 rounded-full bg-link text-inverse cursor-pointer"
                  >
                    5
                  </div>
                  <div
              ...
              <div className="card">
                ...
                <div className="grid grid-cols-7 gap-2 text-center">
                  ...
                  <div className="font-bold text-secondary">S</div>
                  <div
                    className="col-start-5 p-2 rounded-full hover-surface cursor-pointer"
                  >
                    1
                  </div>
                  <div
            ...
            <div className="mt-8">
              <h2 className="text-2xl font-bold text-primary text-center mb-6">Workshop Analytics</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mx-4">
                ...
                <div className="card flex flex-col items-center justify-center p-6">
                  <p className="text-base text-secondary text-center">Average Feedback Score</p>
                  <p className="text-3xl font-bold text-primary mt-2 text-center">
                    4.5/5
                  </p>
                </div>
            ...
            <div className="mt-8">
              <h2 className="text-2xl font-bold text-primary">Content Library</h2>
                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    <tr className="border-b hover-surface">
                      <td
                        className="p-4 text-base text-link font-medium"
                      >
                        Workshop 1
                      </td>
                      <td
                        className="p-4 text-base text-secondary"
                      >
                        Onboarding
                      </td>
                      <td
                    ...
                    <tr className="border-b hover-surface">
                      ...
                      <td className="p-4">
                        <span
                          className="px-3 py-1 text-sm rounded-full bg-blue-100 text-link"
                          >Upcoming</span
                        >
                      </td>
                    </tr>
